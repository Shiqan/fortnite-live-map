...
namespace FortniteReplayObserver.Mqtt.MapTracker
{
    public class TrackerMqttObserver : BaseMqttObserver<PlayerElimination>
    {
        public TrackerMqttObserver() : base() { }

        protected override string CreateTopic()
        {
            return $"Fortnite/{Settings.Topic}/location";
        }
